...
// direct add to cart
$(document).on('click', '.direct_add_cart', function() {
...
// });
 ...
 // copy billing address to shiffing address
  $("#copyBillToShip").click(function(event) {
...
function addContactDetails(){
    ...
    // replace main image from by alternate image
