        ...
        <div class="col-lg-12">
            ...
            @if(Session::get('error'))
                <div id="msg" class="alert alert-danger left-icon-alert text-center" role="alert">
                    <strong>Opppppss! &nbsp;</strong>{{ Session::get('error') }}
                </div>
            @endif
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $totalRegCustomers }}</div>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $totalAdmins }}</div>
                                <div>Total Admin</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">Tk. {{ $totalAmount }}</div>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $totalQuantitys }} Items</div>
                                <div>Total Selled Product</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
