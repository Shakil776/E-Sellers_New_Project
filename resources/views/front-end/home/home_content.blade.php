...
<!-- collection banner -->
    <section class="pb-0 ratio2_1">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="{{ asset('/custom-product/salwar-kamiz') }}">
                ...
                <div class="col-md-6">
                <a href="{{ url('register') }}#top-review">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                            ...
                            <div class="contain-banner">
                                <div>
                                    <h4>Increase Your Business With Us ?</h4>
                                    <h2>Create Shop</h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{ asset('/product-details/'.$allProduct->id) }}"><img src="{{ asset($allProduct->product_image) }}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="{{ asset('/product-details/'.$allProduct->id) }}"><img src="{{ asset($allProduct->back_image) }}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
    ...
    <!-- Parallax banner -->
    @include('front-end.includes.parallax_banner')
    <!-- Parallax banner end -->
                    ...
                    <div class="theme-tab">
                        ...
                        <div class="tab-content-cls">
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider row">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="{{ asset('/product-details/'.$newProduct->id) }}"><img src="{{ asset($newProduct->product_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="{{ asset('/product-details/'.$newProduct->id) }}"><img src="{{ asset($newProduct->back_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>

                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" title="Add to cart">
                                                    <a href="javascript:" class="direct_add_cart" id="<?php echo $newProduct->id; ?>"><i class="fas fa-cart-arrow-down"></i></a>
                                                </button>
                                                <a href="javascript:" title="Add to Wishlist" class="add_to_wishlist" id="<?php echo $newProduct->id; ?>">
                                                    <i class="far fa-heart"></i>
                                                </a>
                                                <a href="{{ asset('/product-details/'.$newProduct->id) }}" title="Buy Now" class="quick-view">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <div class="rating-block">
                                            <?php $rating = round($newProduct->rating); ?>
                                            ...
                                            <a href="{{ asset('/product-details/'.$newProduct->id) }}">
                                                <h6>{{ $newProduct->product_name }}</h6>
                                            </a>
                                            <h4>TK. {{ $newProduct->product_price }}</h4>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div id="tab-5" class="tab-content">
                                ...
                                @foreach($featureProducts as $featureProduct)
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="{{ asset('/product-details/'.$featureProduct->id) }}"><img src="{{ asset($featureProduct->product_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="{{ asset('/product-details/'.$featureProduct->id) }}"><img src="{{ asset($featureProduct->back_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>

                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" title="Add to cart">
                                                    <a href="javascript:" class="direct_add_cart" id="<?php echo $featureProduct->id; ?>"><i class="fas fa-cart-arrow-down"></i></a>
                                                </button>
                                                <a href="javascript:" title="Add to Wishlist" class="add_to_wishlist" id="<?php echo $featureProduct->id; ?>">
                                                    <i class="far fa-heart"></i>
                                                </a>
                                                <a href="{{ asset('/product-details/'.$featureProduct->id) }}" title="Buy Now" class="quick-view">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <div class="rating-block">
                                            <?php $rating = round($featureProduct->rating); ?>
                                            ...
                                            <a href="{{ asset('/product-details/'.$featureProduct->id) }}">
                                                <h6>{{ $featureProduct->product_name }}</h6>
                                            </a>
                                            <h4>TK. {{ $featureProduct->product_price }}</h4>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div id="tab-6" class="tab-content">
                                <div class="no-slider row">
                                @foreach($bestSellersProducts as $bestSellersProduct)
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="{{ asset('/product-details/'.$bestSellersProduct->id) }}"><img src="{{ asset($bestSellersProduct->product_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="{{ asset('/product-details/'.$bestSellersProduct->id) }}"><img src="{{ asset($bestSellersProduct->back_image) }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>

                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" title="Add to cart">
                                                    <a href="javascript:" class="direct_add_cart" id="<?php echo $bestSellersProduct->id; ?>"><i class="fas fa-cart-arrow-down"></i></a>
                                                </button>
                                                <a href="javascript:" title="Add to Wishlist" class="add_to_wishlist" id="<?php echo $bestSellersProduct->id; ?>">
                                                    <i class="far fa-heart"></i>
                                                </a>
                                                <a href="{{ asset('/product-details/'.$bestSellersProduct->id) }}" title="Buy Now" class="quick-view">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <div class="rating-block">
                                            <?php $rating = round($bestSellersProduct->rating); ?>
                                            ...
                                            <a href="{{ asset('/product-details/'.$bestSellersProduct->id) }}">
                                                <h6>{{ $bestSellersProduct->product_name }}</h6>
                                            </a>
                                            <h4>TK. {{ $bestSellersProduct->product_price }}</h4>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
